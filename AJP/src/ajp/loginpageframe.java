...
public class loginpageframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(470, 120, 350, 200);
...
String pw=String.valueOf(ch);
 if(uname.isEmpty())
     {
        JOptionPane.showMessageDialog(null," username no is Empty");
     }
     else if(pw.isEmpty())
     {
        JOptionPane.showMessageDialog(null,"password no is empty");
         ...
         loginmaker l=new loginmaker();
         if(l.dologin(uname, pw)) 
         {
         this.dispose();
             mainframe plog=new mainframe();
         ...
         {
              JOptionPane.showMessageDialog(null,"Password are wrong!"); 
         }
